...
curl -X POST "https://api.clevrscan.com/api/sync/upload_ocr_sync" \
  -H "Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJmcmVzaCI6dHJ1ZSwiaWF0IjoxNzU2Mzk3OTA3LCJqdGkiOiJlZWJkZmU1Ni02MTE5LTRhYjUtYWI3My1hNDBiOTBiNDI1NTgiLCJ0eXBlIjoiYWNjZXNzIiwic3ViIjoiNDA0IiwibmJmIjoxNzU2Mzk3OTA3LCJjc3JmIjoiNTcwZTRlY2UtMjQ1MC00M2VkLWEwMWEtZDgxZjA2NmYxOGExIiwiZXhwIjoxNzg3OTMzOTA3fQ.DnTOh9wafiQeY59FOXJMnqmmGOVBQ_DntdpVRjUYk08" \
...
```json 400
{
  "error": "Invalid request. Please provide a valid file and template."
}
```
